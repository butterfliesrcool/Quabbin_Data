...
Do pairwise glms comparing each day to get specific significance measurements and make a bargraph with the *** for attacks on each day (like susan did?)

also make a bar graph showing total attacks on each species for days 2-4
can the maximum likelihood allow me to statistically compare this number between limenitis and battus directly 
